...
import { addProduct, minusProduct, removeProduct } from "../../../redux/cartSlice";

const CartItem: React.FC<PizzaType> = ({ id, imageUrl, title, type, size, price, count }) => {

	const dispatch = useDispatch()
	const onClickPlus = () => {
		dispatch(addProduct({ id } as PizzaType))
	}
	const onClickMinus = () => {
